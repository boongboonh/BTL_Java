...
public class NhanVienManagementPanel extends javax.swing.JPanel {
    ...
    public void addNhanVien(){
       ...
       if(!nameNVM.getText().trim().equals("")){          
         ...
         //Kiểm tra ngày sinh
         if(!birthdayNVM.getText().trim().equals("")){
        ...
        //Kiểm tra lương
        if(!priceNVM.getText().trim().equals("")){
        ...
        if(!workdayNVM.getText().trim().equals("")){
        ...
        //Check addredss
        if(!addressNVM.getText().trim().equals("")){
        ...
        //Kiểm tra sdt
        if(!phoneNVM.getText().trim().equals("")){
        ...
        //Kiểm tra email'
        if(!emailNVM.getText().trim().equals("")){
       ...
       if(rdNam.isSelected()==true){
        ...
        list.add(nv);
        new ReadWriteFile().WriteToNhanVien(list);
