...
public class HangHoaDetailDialog extends javax.swing.JDialog {
     ...
     */
    public HangHoaDetailDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Thời gian nhập");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HangHoaDetailDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HangHoaDetailDialog dialog = new HangHoaDetailDialog(new javax.swing.JFrame(), true);
