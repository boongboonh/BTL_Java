...
public class kiemSoatHSD extends javax.swing.JFrame {
    ...
    public void readFileHH() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "không tìm thấy file hàng hoá");
    ...
    private void btSrearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSrearchActionPerformed
        ...
        for (int i = 0; i < hh.size(); i++) {
            if ((hh.get(i).tenHang.toLowerCase()).indexOf(tukhoa.toLowerCase()) >= 0 || hh.get(i).hangHoaID.toLowerCase().indexOf(tukhoa.toLowerCase()) >= 0) {
                try {
